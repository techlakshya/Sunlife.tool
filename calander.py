...
#--------------------------------------------------------------First Screen--------------------------------------------------------------------------------------------------    
    ...
    def Main_fram(lak):
        ...
        # Nevigation button
        Mbutton2= Button(lak.root, command= lak.Amount, activebackground= "#031b28",width=30, activeforeground= "white", 
        text = "   Amount Caculation   ",fg= "black", bg= "white",font = ("Arial", 12, "bold "))
        Mbutton2.place(x=0,y=0)
        Mbutton2= Button(lak.root, command= lak.GUI, activebackground= "#031b28",width=30, activeforeground= "white", 
        text = " Address ",fg= "black", bg= "white",font = ("Arial", 12, "bold"))
        Mbutton2.place(x=300,y=0)
    def plan_search(lak):
...
#--------------------------------------------------------------Second Screen--------------------------------------------------------------------------------------
    ...
    def Amount(lak):
        ...
        lak.fbg=ImageTk.PhotoImage(file="E:\\Sunlife\\slbg.jpg")
        label_fbg=Label(lak.Mframe, image=lak.fbg,borderwidth=0)
        label_fbg.place(x=0,y=0,relwidth=1,relheight=1)
        # Nevigation button
        Mbutton2= Button(lak.root, command= lak.Main_fram, activebackground= "#031b28",width=30, activeforeground= "white", 
