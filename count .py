...
class Traacker(Thread):
    ...
    def trackkerr(lak):
        ...
        S_Notify.cell(row=Q, column=3).value= int(lak.Pcount1.get())
        S_Notify.cell(row=Q, column=4).value= int(lak.Pcount2.get())
        S_Notify.cell(row=Q, column=5).value= int(lak.Pcount3.get())
        S_Notify.cell(row=Q, column=6).value= int(lak.Pcount4.get())
        S_Notify.cell(row=Q, column=7).value= int(lak.Tcount1.get())
        S_Notify.cell(row=Q, column=8).value= int(lak.Tcount2.get())
        S_Notify.cell(row=Q, column=9).value= int(lak.Tcount3.get())
        S_Notify.cell(row=Q, column=10).value= int(lak.Tcount4.get())
